...
We welcome contributions from the community! There are several ways you can contribute to the access-cryosphere-data-pool project:

1. **Reporting Issues**: If you encounter any bugs or have suggestions for improvements, please open an issue on our `GitHub repository <https://github.com/ACCESS-NRI/access-cryosphere-data-pool/issues>`_.
...
4. **Joining Discussions**: Participate in discussions on the `Hive Forum <https://forum.access-hive.org.au/c/cryosphere/data>`_ to help shape the future of access-cryosphere-data-pool.
